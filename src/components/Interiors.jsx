        ...
        <section id="explore" className="top-container-1">
            <div className="">
                <div className="">
                    ...
                    <p className="mx-auto text-gray-400  fontmobile  text-center  mb-8">Get hassle-free project management and execution when it comes to building your dream home with a tailor-made service.</p>
                </div>
